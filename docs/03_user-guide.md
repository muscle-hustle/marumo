...
- 顔をピクセル化して見えなくします
- 最も一般的な加工方法です
- **強度調整**: 1-5の範囲で調整可能（デフォルト: 3）
  - 強度が低いほどモザイクが細かくなり、元の顔が見えやすくなります
  - 強度が高いほどモザイクが粗くなり、元の顔が見えにくくなります
...
3. 加工種類（モザイク/ぼかし/スタンプ）を選択します
4. モザイクまたはぼかしを選択した場合、強度スライダーで強度を調整できます
   - 強度を変更すると、自動的に加工が再適用されます
   - リアルタイムでプレビューが更新されます
5. スタンプを選択した場合は、スタンプの種類を選択できます（強度調整は不要）
6. 「ダウンロード」ボタンで保存します

**コツ**:
- 顔がはっきり写っている画像ほど検出精度が高くなります
- 検出されなかった顔は、手動モードで追加できます
- 強度はデフォルト（5）で十分な場合が多いですが、必要に応じて調整してください
...
6. 加工種類を選択します
7. モザイクまたはぼかしを選択した場合、強度スライダーで強度を調整できます
   - 強度を変更すると、自動的に加工が再適用されます
8. 加工が適用されます
9. 必要に応じて、他の顔も同様に処理します
10. 「ダウンロード」ボタンで保存します
...
7. 加工種類を選択します
8. モザイクまたはぼかしを選択した場合、強度スライダーで強度を調整できます
   - 強度を変更すると、自動的に加工が再適用されます
9. 加工が適用されます
10. 「ダウンロード」ボタンで保存します
...
**注意事項**:
- モザイクとぼかしには強度調整機能があります（1-10の範囲、デフォルト: 5）
- 強度を変更すると、自動的に加工が再適用され、リアルタイムでプレビューが更新されます
- スタンプには強度調整は不要です（サイズは自動調整されます）
