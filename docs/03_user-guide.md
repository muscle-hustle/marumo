...
画像を選択すると、以下の2つのモードから選択できます。

#### 自動モード
- 画像内のすべての顔を自動的に検出します
- 検出された顔に自動的にモザイク加工を適用します
- **推奨**: 複数の顔を一度に処理したい場合
...
2. 「自動モード」を選択します
3. 「顔を検出」ボタンをクリックします
4. 検出された顔が自動的にハイライト表示されます
5. 加工種類（モザイク/ぼかし/スタンプ）を選択します
6. 加工が自動的に適用されます
7. 「ダウンロード」ボタンで保存します
...
「高度な設定」を有効にすると、以下の調整が可能になります。

#### モザイクの強度
- スライダーで細かさを調整できます（1-10）
- 数値が大きいほど細かいモザイクになります

#### ぼかしの強度
- スライダーでぼかしの強さを調整できます（1-10）
- 数値が大きいほど強くぼかされます

**注意事項**:
- 高度な設定は、基本的な使い方に慣れてから使用することをおすすめします
